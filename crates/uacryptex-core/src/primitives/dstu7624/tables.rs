//! Precomputed Kalyna tables from Cryptonite `dstu7624.c` (DSTU7624_SBOX_1).

pub const S_BLOCKS: [u8; 1024] = [
...
pub const S_BLOCKS_REV: [u8; 1024] = [
...
pub const SUBROWCOL_DEC: [[u64; 256]; 8] = [
    [
        0x7826942b9f5f8a9a,
        0x210f43c934970c53,
        0x5f028fdd9d0551b8,
